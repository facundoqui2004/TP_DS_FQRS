...
import { sanitizeMultasInput, findAll, findOne, add, update, remove, pagarMulta, generarDatosAstroPay } from './Multa.controller.js'
...
multasRouter.post('/:id/datos-astropay', requireAuth, generarDatosAstroPay) // Obtener alias/link AstroPay
